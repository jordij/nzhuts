# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-23 09:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw_facilities', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=100), blank=True, size=None)),
                ('intro', models.TextField(blank=True, max_length=3000)),
                ...
                ('raw_landscape', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=100), blank=True, size=None)),
                ('powered_sites', models.PositiveIntegerField(blank=True)),
                ('unpowered_sites', models.PositiveIntegerField(blank=True)),
                ('raw_activities', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=100), blank=True, size=None)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('Standard', 'Standard'), ('Basic/Bivvies', 'Basic/Bivvies'), ('Serviced', 'Serviced'), ('Great Walks', 'Great Walks'), ('Scenic', 'Scenic'), ('Serviced Alpine', 'Serviced Alpine')], max_length=200)),
                ('proximity', models.CharField(blank=True, max_length=200)),
