# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-24 10:44
...
def populate_data(apps, schema_editor):
    ...
    homepage = HomePage(title="New Zealand Huts and Campsites")
    ...
    hut_index = HutIndexPage(title="Huts")
    campsite_index = CampsiteIndexPage(title="Campsites")

    homepage.add_child(instance=hut_index)
    homepage.add_child(instance=campsite_index)
